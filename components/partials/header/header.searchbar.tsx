...
const HeaderSearchbar = () => {
  ...
  const searchHandler = async () => {
    ...
    const usersResponse = await searchUsers(searchValue)
  ...
  return (
    <Popover open={results.length > 0} modal={true}>
      ...
      <PopoverContent align={'start'} side={'bottom'} className={'w-96 p-1'}>
        ...
        {/*<div className={'flex flex-col text-sm/none'}>*/}
        {/*  {users.map((item, itemIndex) => (*/}
        {/*    <div key={`result-${itemIndex}`}>{item.id}</div>*/}
        {/*  ))}*/}
        {/*<div>hello</div>*/}
        {/*<div>hello</div>*/}
        {/*<div>hello</div>*/}
